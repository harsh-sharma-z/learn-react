...
const ShoppingList = () => {
    const products=[
        {name:"MackBook Pro",price:1800,img:"https://www.apple.com/newsroom/images/product/mac/standard/Apple_MacBook-Pro_14-16-inch_10182021_big.jpg.slideshow-large_2x.jpg"},
